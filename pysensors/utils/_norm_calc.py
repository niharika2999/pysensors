...
def distance(lin_idx, dlens, piv, j, n_const_sensors, **kwargs):   #j,dlens,dlens_old,piv,nx,ny,r, all_sensors, n_sensors
    ...
    if 'dlens_old' in kwargs.keys():
        ...
        dlens_old = []
    if j == 0:
        idx_constrained = ps.utils._constraints.get_constrained_sensors_indices_distance(j,piv,r, nx,ny, all_sensors)
        ...
        idx_constrained1 = ps.utils._constraints.get_constrained_sensors_indices_distance(j,piv,r, nx,ny, all_sensors)
        print(idx_constrained1)
